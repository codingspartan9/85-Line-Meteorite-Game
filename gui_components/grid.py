...
class Grid:
    ...
    def turn_into_grid(self, items, max_length, max_height):
        ...
        item_height = self.get_item_dimension(self.dimensions.height, rows, max_height, self.height_buffer)
        item_length = self.get_item_dimension(self.dimensions.length, columns, max_length, self.length_buffer)
